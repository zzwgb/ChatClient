...
import com.carson.factory.presenter.user.UpdateInfoContract;
import com.carson.factory.presenter.user.UpdateInfoPresenter;
...
public class UpdateInfoFragment extends PresenterFragment<UpdateInfoContract.Presenter>
    ...
    void onPortraitClick() {
        new GalleryFragment()
                ...
                })// show 的时候建议使用getChildFragmentManager，tag GalleryFragment class名
